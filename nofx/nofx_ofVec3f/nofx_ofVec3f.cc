...
namespace nofx
{
	namespace ClassWrappers
	{
		...
		NAN_METHOD(OfVec3fWrap::New)
		{
			...
			if (args.IsConstructCall()) {
				...
				else if (args.Length() == 1)
				{
					...
					{
						obj = new OfVec3fWrap(new ofVec3f(*ObjectWrap::Unwrap<nofx::ClassWrappers::OfVec2fWrap>(args[0]->ToObject())->GetWrapped()));
					}
					else if (args[0]->ToObject()->Get(NanNew("NOFX_TYPE"))->Uint32Value() == NOFX_TYPES::OFVEC4F)
					{
						obj = new OfVec3fWrap(new ofVec3f(*ObjectWrap::Unwrap<nofx::ClassWrappers::OfVec4fWrap>(args[0]->ToObject())->GetWrapped()));
					}
					else
					{
		...
		NAN_METHOD(OfVec3fWrap::GetPtr)
		{
			...
			ObjectWrap::Unwrap<nofx::Pointer::RawPointerWrap<float>>(JsFloatPtr->ToObject())->SetWrapped(ObjectWrap::Unwrap<OfVec3fWrap>(args.This())->GetWrapped()->getPtr());
