...
namespace nofx
{
	namespace ClassWrappers
	{
		...
		NAN_METHOD(OfVec4fWrap::New)
		{
			...
			if (args.IsConstructCall()) {
				...
				else if (args.Length() == 1)
				{
					...
					{
						obj = new OfVec4fWrap(new ofVec4f(*ObjectWrap::Unwrap<nofx::ClassWrappers::OfVec2fWrap>(args[0]->ToObject())->GetWrapped()));
					}
		...
		NAN_METHOD(OfVec4fWrap::GetPtr)
		{
			...
			ObjectWrap::Unwrap<nofx::Pointer::RawPointerWrap<float>>(JsFloatPtr->ToObject())->SetWrapped(ObjectWrap::Unwrap<OfVec4fWrap>(args.This())->GetWrapped()->getPtr());
